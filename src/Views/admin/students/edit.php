<?php 
\Libs\Web\Page::setTitle("ASRI for Speaking | Edit Data Mahasiswa");
    ...
    <div class="card shadow-sm rounded-3">
      ...
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="/students" class="btn btn-secondary">
          <i class="fas fa-list mr-2"></i> Daftar Mahasiswa
        </a>
      </div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-7 col-sm-12">
            <form action="/students?id=<?=$id?>" method="post" id="form1" autocomplete="off">
