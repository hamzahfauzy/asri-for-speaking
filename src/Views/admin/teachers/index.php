...
<div class="card">
    <div class="card-header">
        ...
        <?php if (auth()['level'] == 'admin') : ?>
            <a href="/teachers/create" class="btn btn-primary"><i class="fas fa-plus-circle mr-2"></i> Tambah Baru</a>
        <?php endif ?>
    </div>
    <div class="card-body">
                    ...
                    foreach ($users as $user) { 
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- DETAIL -->
                                 <?php /*
                                <a href="/teachers/detail?id=<?=$id?>" class="btn btn-info" title="Detail">
                                    <i class="fas fa-eye"></i>
                                </a> */ ?>
                                
                                <a href="/teachers/edit?id=<?=$id?>" class="btn btn-success" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <!-- HAPUS -->
                                <form action="/teachers?id=<?=$id?>" method="post" style="display:inline;">
