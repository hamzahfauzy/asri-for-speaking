document.addEventListener("DOMContentLoaded", () => {
  ...
  const identificationWordsData = ["Key", "Result", "Description", "Presentation", "Question", "Money", "Cycling", "Environment", "Stove", "Japan", "Gas"
  , "Shoes", "Development", "Function", "Wheel", "Production", "Animal", "Advantage", "Accident", "Knife", "Idea", "Chair", "Beach"
  , "Original", "Reason", "Muscles", "House", "Housewife", "Worker", "Employer", "Business", "Market ", "Shop", "Customer", "Product"
  , "Service", "Technology", "Science", "Experiment", "Laboratory", "Equipment", "Machine", "Engine", "Factory", "Industry", "Agriculture", "Farm"
  ...
  const notificationWordsData = ["Key", "Result", "Description", "Presentation", "Question", "Money", "Cycling", "Environment", "Stove", "Japan", "Gas"
  , "Shoes", "Development", "Function", "Wheel", "Production", "Animal", "Advantage", "Accident", "Knife", "Idea", "Chair", "Beach"
  , "Original", "Reason", "Muscles", "House", "Housewife", "Worker", "Employer", "Business", "Market ", "Shop", "Customer", "Product"
  , "Service", "Technology", "Science", "Experiment", "Laboratory", "Equipment", "Machine", "Engine", "Factory", "Industry", "Agriculture", "Farm"
  , "Field ", "Crop", "Livestock"];
  ...
  const descriptionWordsData = [
    {
      ...
      meaning_intro: "The word 'key' can refer to:",
      meanings: ["A device used to operate a lock", "A crucial element", "A symbol or character used in music or typing"],
      examples: ["I need the key to unlock the door."],
    },
    {
      word: "Result",
      spelling: "R-E-S-U-L-T",
      pronunciation_ipa: "/rɪˈzʌlt/",
      pronunciation_approx: "(ri-ZULT)",
      meaning_intro: "The word 'result' is a noun that refers to a consequence or outcome of a particular action or situation.",
      meanings: [],
      examples: ["The result of the game surprised everyone."],
    },
    {
      word: "Description",
      spelling: "D-E-S-C-R-I-P-T-I-O-N",
      pronunciation_ipa: "/dɪˈskrɪpʃən/",
      pronunciation_approx: "(di-SKRIP-shun)",
      meaning_intro: "The word 'description' is a noun that refers to a statement or account that describes something or someone.",
      meanings: [],
      examples: ["The real estate agent gave a detailed description of the property."],
    },
    {
      word: "Presentation",
      spelling: "P-R-E-S-E-N-T-A-T-I-O-N",
      pronunciation_ipa: "/ˌprɛzənˈteɪʃən/",
      pronunciation_approx: "(prez-en-TAY-shun)",
      meaning_intro: "The word 'presentation' is a noun that refers to the act of showing or offering something, often in a formal setting.",
      meanings: [],
      examples: ["The team gave an impressive presentation at the conference."],
    },
    {
      word: "Question",
      spelling: "Q-U-E-S-T-I-O-N",
      pronunciation_ipa: "/ˈkwɛstʃən/",
      pronunciation_approx: "(KWES-chun)",
      meaning_intro: "The word 'question' is a noun that refers to a sentence or phrase asking for information or a query.",
      meanings: [],
      examples: ["Do you have any questions about the project?"],
    },
  ];
  ...
  const applicationWordsData = ["Book", "Chair", "Table", "Car", "House", "Tree", "Dog", "Cat", "Pen", "Paper", "Phone"
  , "Computer", "School", "Teacher", "Student", "City", "Country", "Mountain", "River", "Ocean", "Fish", "Bird", "Flower"
  , "Garden", "Bike", "Train", "Bus", "Airport", "Hotel", "Restaurant", "Food", "Water", "Juice", "Fruit", "Vegetable"
  , "Meat", "Bread", "Cake", "Music", "Movie", "Bookstore", "Library", "Park", "Playground", "Hospital", "Doctor", "Nurse"
  , "Medicine", "Bed", "Pillow"];
  ...
  const harmonizationWordsData = ["Blanket", "Window", "Door", "Wall", "Floor", "Ceiling", "Roof", "Garden", "Yard", "Fence", "Gate"
  , "Street", "Road", "Highway", "Bridge", "Tunnel", "Building", "Office", "Shop", "Market", "Mall", "Supermarket", "Bank"
  , "Money", "Credit card", "Phone card", "Ticket", "Passport", "Border", "Map", "Compass", "Clock", "Watch", "Calendar", "Newspaper"
  , "Magazine", "Camera", "Photo", "Picture", "Painting", "Museum", "Art", "Music instrument", "Song", "Singer", "Band", "Concert"
  , "Theater", "Play", "Actor"];
  ...
  completeHarmonizationBtn.addEventListener("click", () => {
    ...
    lessonContent.harmonization.innerHTML = `
      <div class="harmonization-completion">
        <h3>Congratulations! Lesson 2 Complete! 🎉</h3>
        <p>You have successfully finished all stages of the Noun lesson. Excellent work!</p>
